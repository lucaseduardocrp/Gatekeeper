...
namespace Gatekeeper.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(double val, decimal comparer, string key) =>
            IsGreaterOrEqualsThan(val, (double)comparer, key, GatekeeperErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(double val, decimal comparer, string key) =>
            IsLowerOrEqualsThan(val, (double)comparer, key, GatekeeperErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsMinValue(double val, string key) =>
            IsMinValue(val, key, GatekeeperErrorMessages.IsMinValueErrorMessage(key, double.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(double val, string key) =>
            IsNotMinValue(val, key, GatekeeperErrorMessages.IsNotMinValueErrorMessage(key, double.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(double val, string key) =>
            IsMaxValue(val, key, GatekeeperErrorMessages.IsMaxValueErrorMessage(key, double.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(double val, string key) =>
            IsNotMaxValue(val, key, GatekeeperErrorMessages.IsNotMaxValueErrorMessage(key, double.MaxValue.ToString()));
        ...
        public Contract<T> AreEquals(double val, int comparer, string key) =>
            AreEquals(val, (double)comparer, key, GatekeeperErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(double val, int comparer, string key) =>
            AreNotEquals(val, (double)comparer, key, GatekeeperErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(double val, int start, int end, string key) =>
            IsBetween(val, (double)start, (double)end, key, GatekeeperErrorMessages.IsBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(double val, int start, int end, string key) =>
            IsNotBetween(val, (double)start, (double)end, key, GatekeeperErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));

...
namespace Gatekeeper.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(int val, decimal comparer, string key) =>
            IsGreaterOrEqualsThan(val, (int)comparer, key, GatekeeperErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(int val, decimal comparer, string key) =>
            IsLowerOrEqualsThan(val, (int)comparer, key, GatekeeperErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsMinValue(int val, string key) =>
            IsMinValue(val, key, GatekeeperErrorMessages.IsMinValueErrorMessage(key, int.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(int val, string key) =>
            IsNotMinValue(val, key, GatekeeperErrorMessages.IsNotMinValueErrorMessage(key, int.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(int val, string key) =>
            IsMaxValue(val, key, GatekeeperErrorMessages.IsMaxValueErrorMessage(key, int.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(int val, string key) =>
            IsNotMaxValue(val, key, GatekeeperErrorMessages.IsNotMaxValueErrorMessage(key, int.MaxValue.ToString()));
        ...
        public Contract<T> AreEquals(int val, float comparer, string key) =>
            AreEquals(val, (int)comparer, key, GatekeeperErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(int val, float comparer, string key) =>
            AreNotEquals(val, (int)comparer, key, GatekeeperErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(int val, float start, float end, string key) =>
            IsBetween(val, (int)start, (int)end, key, GatekeeperErrorMessages.IsBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(int val, float start, float end, string key) =>
            IsNotBetween(val, (int)start, (int)end, key, GatekeeperErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));

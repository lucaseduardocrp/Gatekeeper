...
namespace Gatekeeper.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(long val, decimal comparer, string key) =>
            IsGreaterOrEqualsThan(val, (long)comparer, key, GatekeeperErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(long val, decimal comparer, string key) =>
            IsLowerOrEqualsThan(val, (long)comparer, key, GatekeeperErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsMinValue(long val, string key) =>
            IsMinValue(val, key, GatekeeperErrorMessages.IsMinValueErrorMessage(key, long.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(long val, string key) =>
            IsNotMinValue(val, key, GatekeeperErrorMessages.IsNotMinValueErrorMessage(key, long.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(long val, string key) =>
            IsMaxValue(val, key, GatekeeperErrorMessages.IsMaxValueErrorMessage(key, long.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(long val, string key) =>
            IsNotMaxValue(val, key, GatekeeperErrorMessages.IsNotMaxValueErrorMessage(key, long.MaxValue.ToString()));
        ...
        public Contract<T> AreEquals(long val, float comparer, string key) =>
            AreEquals(val, (long)comparer, key, GatekeeperErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(long val, float comparer, string key) =>
            AreNotEquals(val, (long)comparer, key, GatekeeperErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(long val, float start, float end, string key) =>
            IsBetween(val, (long)start, (long)end, key, GatekeeperErrorMessages.IsBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(long val, float start, float end, string key) =>
            IsNotBetween(val, (long)start, (long)end, key, GatekeeperErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));

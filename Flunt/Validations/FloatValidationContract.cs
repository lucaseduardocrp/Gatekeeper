...
namespace Gatekeeper.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(float val, decimal comparer, string key) =>
            IsGreaterOrEqualsThan(val, (float)comparer, key, GatekeeperErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(float val, decimal comparer, string key) =>
            IsLowerOrEqualsThan(val, (float)comparer, key, GatekeeperErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> AreEquals(float val, int comparer, string key) =>
            AreEquals(val, (float)comparer, key, GatekeeperErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(float val, int comparer, string key) =>
            AreNotEquals(val, (float)comparer, key, GatekeeperErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(float val, int start, int end, string key) =>
            IsBetween(val, (float)start, (float)end, key, GatekeeperErrorMessages.IsBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(float val, int start, int end, string key) =>
            IsNotBetween(val, (float)start, (float)end, key, GatekeeperErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));

...
namespace Gatekeeper.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(decimal val, double comparer, string key) =>
            IsGreaterOrEqualsThan(val, (decimal)comparer, key, GatekeeperErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(decimal val, double comparer, string key) =>
            IsLowerOrEqualsThan(val, (decimal)comparer, key, GatekeeperErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsMinValue(decimal val, string key) =>
            IsMinValue(val, key, GatekeeperErrorMessages.IsMinValueErrorMessage(key, decimal.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(decimal val, string key) =>
            IsNotMinValue(val, key, GatekeeperErrorMessages.IsNotMinValueErrorMessage(key, decimal.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(decimal val, string key) =>
            IsMaxValue(val, key, GatekeeperErrorMessages.IsMaxValueErrorMessage(key, decimal.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(decimal val, string key) =>
            IsNotMaxValue(val, key, GatekeeperErrorMessages.IsNotMaxValueErrorMessage(key, decimal.MaxValue.ToString()));
        ...
        public Contract<T> AreEquals(decimal val, int comparer, string key) =>
            AreEquals(val, (decimal)comparer, key, GatekeeperErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(decimal val, int comparer, string key) =>
            AreNotEquals(val, (decimal)comparer, key, GatekeeperErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(decimal val, int start, int end, string key) =>
            IsBetween(val, (decimal)start, (decimal)end, key, GatekeeperErrorMessages.IsBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(decimal val, int start, int end, string key) =>
            IsNotBetween(val, (decimal)start, (decimal)end, key, GatekeeperErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(GatekeeperFormats.DateTimeFormat), end.ToString(GatekeeperFormats.DateTimeFormat)));
